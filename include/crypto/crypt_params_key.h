...
#define CRYPT_PARAM_ENCODE_OUTPUT_FORMAT                    (CRYPT_PARAM_ENCODE_BASE + 1)
#define CRYPT_PARAM_ENCODE_OUTPUT_TYPE                      (CRYPT_PARAM_ENCODE_BASE + 2)
#define CRYPT_PARAM_ENCODE_PASSWORD                         (CRYPT_PARAM_ENCODE_BASE + 3)
#define CRYPT_PARAM_ENCODE_KEY_TYPE                         (CRYPT_PARAM_ENCODE_BASE + 4)
#define CRYPT_PARAM_ENCODE_BUFFER_DATA                      (CRYPT_PARAM_ENCODE_BASE + 5)
#define CRYPT_PARAM_ENCODE_OBJECT_DATA                      (CRYPT_PARAM_ENCODE_BASE + 6)
#define CRYPT_PARAM_ENCODE_OBJECT_TYPE                      (CRYPT_PARAM_ENCODE_BASE + 7)
#define CRYPT_PARAM_ENCODE_PKEY_EXPORT_METHOD_FUNC          (CRYPT_PARAM_ENCODE_BASE + 8)
#define CRYPT_PARAM_ENCODE_PKEY_DUP_METHOD_FUNC             (CRYPT_PARAM_ENCODE_BASE + 9)
#define CRYPT_PARAM_ENCODE_PKEY_FREE_METHOD_FUNC            (CRYPT_PARAM_ENCODE_BASE + 10)
#define CRYPT_PARAM_ENCODE_LIB_CTX                          (CRYPT_PARAM_ENCODE_BASE + 11)
#define CRYPT_PARAM_ENCODE_TARGET_ATTR_NAME                 (CRYPT_PARAM_ENCODE_BASE + 12)
#define CRYPT_PARAM_ENCODE_PROVIDER_CTX                     (CRYPT_PARAM_ENCODE_BASE + 13)
#define CRYPT_PARAM_ENCODE_FLAG_FREE_OUTDATA                (CRYPT_PARAM_ENCODE_BASE + 14)
