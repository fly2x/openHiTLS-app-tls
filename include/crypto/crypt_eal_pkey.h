...
typedef struct {
    ...
    union {
        ...
        CRYPT_LmsPub lmsPub; /**< LMS public key structure */
        CRYPT_HssPub hssPub; /**< HSS public key structure */
...
typedef struct {
    ...
    union {
        ...
        CRYPT_LmsPrv lmsPrv; /**< LMS private key structure */
        CRYPT_HssPrv hssPrv; /**< HSS private key structure */
